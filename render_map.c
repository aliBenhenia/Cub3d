...
int	main(void)
{
	...
	map1[0] = strdup("1111111111111111111111111111111111111111111111111111111111111111");
    map1[1] = strdup("100000000000000S000000000000000000000000000000000000000011111111");
    map1[2] = strdup("1000000000000000000000000000000000000000000000000000000011111111");
    map1[3] = strdup("1000000000000000000000000000000000000000000000000000000011111111");
    map1[4] = strdup("1000100000000000000100000000000000000000000000000000000011111111");
    map1[5] = strdup("1000000000000000000000001000000000000000000000000000000011111111");
    map1[6] = strdup("1000000000000000000000001000000000000000000000000000000000000011");
    map1[7] = strdup("1111111111111111111111111111111111111111111111111111111111111111");
    map1[8] = NULL;
	render_map(map1);
	return (0);
}
