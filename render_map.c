...
int	main(void)
{
	...
	map1[0] = strdup("1111");
	map1[1] = strdup("11111110000000000000000011000000000000000000000000000000001");
	map1[2] = strdup("11110000000000000011111110100000000000000000000000000000001");
	map1[3] = strdup("1010010010E000000000000000110000000000000000000000000000001");
	map1[4] = strdup("10000111111111111111100000010000000000000000000000000000001");
	map1[5] = strdup("10000111011111111110000001110000000000000000000000000000001");
